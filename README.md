...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xdk2zoa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xdk2zoa.containers.anotherwebservice.com/
...
```
git clone git@github.com:ddrow768/container-xdk2zoa.git
cd container-xdk2zoa
```
...
```
docker attach container-xdk2zoa
```
